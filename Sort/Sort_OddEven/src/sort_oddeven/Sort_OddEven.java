...
/**
 * Visualizes the Odd-even sort algorithm. For more information visit:
 * https://en.wikipedia.org/wiki/Odd%E2%80%93even_sort
 *
 * @author Samuel Bangslund
 */
public class Sort_OddEven extends Application {
    ...
    static boolean sorted = false;  // Has the pair swapped or not. (Used in sort loop)
    ...
    public void start(Stage primaryStage) {
        ...
        sort(array);                        // Sorts the array with the Odd-Even algorithm.
     ...
     * is based on the Odd-even sort algorithm.
     *
    ...
    void sort(int[] A) {
        new AnimationTimer() {
            ...
            public void handle(long now) {
                // Odd-Even sort algorithm. Based on the psuodo code provided in the wiki.
                // https://en.wikipedia.org/wiki/Odd%E2%80%93even_sort
                if (count % SPEED == 0 && !sorted) {   // Runs in accordance to the SPEED constant.
                    sorted = true;
